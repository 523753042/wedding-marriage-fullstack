<template>
  <div id="tool">
    ...
    <el-button size="mini" @click="showZhenghun = true">紧急通告</el-button>
    <el-dialog
      :modal="true"
      :visible.sync="showZhenghun"
      :append-to-body="true"
      width="100%"
    >
      <div class="zhenghun">走过路过，千万不要错过</div>
      <div class="zhenghun">现新郎有</div>
      <div class="zhenghun">优秀姐姐--项雪</div>
      <div class="zhenghun">单身汪弟弟--夏天</div>
      <div class="zhenghun">望广大单身青年才俊抓住机会</div>
      <div class="zhenghun">
        <el-button class="zhenghun" type="primary" @click="showZhenghun = false"
          >我要报名！</el-button
        >
      </div>
    </el-dialog>
